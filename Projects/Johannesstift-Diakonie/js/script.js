$(document).ready(function () {
  ...
  $('.b-statistics-item__row').each(function (index, el) {
    let that = $(this);
    let w = that.find('.b-statistics-item__row__bar');
    let wWidth = w.width();
    let parent = w.parent().width();
    let result = parseInt(wWidth / parent * 100);
    console.log();
